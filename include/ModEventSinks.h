...
namespace CombatAI
{
    ...
    class EldenParryEventSink : public RE::BSTEventSink<SKSE::ModCallbackEvent>
    {
      public:
        ...
        ProcessEvent(const SKSE::ModCallbackEvent *a_event,
                     [[maybe_unused]] RE::BSTEventSource<SKSE::ModCallbackEvent> *a_eventSource) override;
    };
    ...
    class AttackHitEventSink : public RE::BSTEventSink<RE::TESHitEvent>
    {
      public:
        ...
        ProcessEvent(const RE::TESHitEvent *a_event,
                     [[maybe_unused]] RE::BSTEventSource<RE::TESHitEvent> *a_eventSource) override;
    };
} // namespace CombatAI
